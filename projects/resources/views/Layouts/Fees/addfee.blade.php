...
<div class="row">
  <div class="col-lg-12">
   <h3 class="page-header"><i class="fa fa-money"></i> ADD FEE</h3>
   <ol class="breadcrumb">
    <li><i class="fa fa-home"></i><a href="{{ route('dashboard') }}">Home</a></li>
    <li><i class="fa fa-money"></i>FEES</li>
    <li><i class="fa fa-money"></i>ADD FEE</li>
  </ol>
</div>
</div>
      ...
      <div class="form">
        <form class="form-validate form-horizontal" id="register_form" method="post" action="" >
          <div class="form-group ">
            ...
            <div class="col-lg-10">
              <input class="form-control " id="fee_name" name="fee_name" type="text" />
            </div>
          </div>
          <div class="form-group ">
...
<script>
 $("#register_form").validate({
  ...
  submitHandler: function(form) {
    ...
    $.post("{{ route('storefee') }}", {fee_name:fee_name,desc:desc,duedate:duedate,amount:amount,'_token':$('input[name=_token]').val()}, function(data) {

     $("#sucess").fadeIn();
     $('#sucess').html('<div class="alert alert-success fade in"><strong>Success!</strong> Fee has been Added</div>');
     $("#sucess").fadeOut(3000);
     scrollTo(0,0);
     console.log(data);
