...
@section('content')
 ...
 <div class="row">
        <div class="col-lg-12">
          <h3 class="page-header"><i class="fa fa-files-o"></i> CLASS ATTENDENCE SHEETS</h3>
          <ol class="breadcrumb">
            ...
            <li><i class="fa fa-files-o"></i>CLASS ATTENDENCE SHEETS</li>
       		<li><i class="fa fa-files-o"></i>ADD CLASS ATTENDENCE SHEET</li>
		</ol>
	</div>
</div>
<div class="row">
	...
	$('#savebtn').click(function(event) {
		...
		$(".table tr").each(function(index, val) {
			$(this).find('.attend_id').each(function(index, val) {
				...
				var date=$('#date').val();
				var status=$(this).val();
				$.post("{{ route('addteacherattendencesheet') }}", {class_id:class_id,course_id:course_id,student_id:student_id,status:status,date:date}, function(data) {
					console.log(data);
					$("#sucess").fadeIn();
