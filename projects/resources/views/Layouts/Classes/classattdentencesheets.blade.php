...
<div class="row">
  <div class="col-lg-12">
   <h3 class="page-header"><i class="icon_documents_alt"></i> CLASS ATTENDENCE</h3>
   <ol class="breadcrumb">
    <li><i class="fa fa-home"></i><a href="{{ route('dashboard') }}">Home</a></li>
    <li><i class="icon_desktop"></i>CLASSES</li>
    <li><i class="icon_desktop"></i>ALL CLASSES</li>
    <li><i class="icon_documents_alt"></i>CLASS ATTENDENCE</li>
  </ol>
</div>
</div>
      ...
      <div id="re">
        ...
        <table class="table table-striped table-advance table-hover" id="rows">
         ...
         <tr>
           ...
           <td>
            <div class="btn-group">
             <a class="btn btn-primary attend-btn"  data-date="{{$date->attendence_date}}" data-cid="{{$classroom->course->course_id}}" title="VIEW ATTENDENCE SHEET" data-clid="{{$classroom->class_id}}"><i class="fa fa-eye"></i> VIEW</a>
           </div>
         </td>
       </tr>
       @endforeach                 
...
<form action="{{ route('classattdentencesheet') }}" method="post" id="form-post">
  {{csrf_field()}}
...
<form action="{{ route('addclassattdentencesheet') }}" method="post" id="form-addpost">
  {{csrf_field()}}
