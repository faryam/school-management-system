...
<div class="row">
  <div class="col-lg-12">
   <h3 class="page-header"><i class="icon_desktop"></i> UPDATE CLASS</h3>
   <ol class="breadcrumb">
    <li><i class="fa fa-home"></i><a href="{{ route('dashboard') }}">Home</a></li>
    <li><i class="icon_desktop"></i>CLASSES</li>
    <li><i class="icon_desktop"></i>ALL CLASS</li>
    <li><i class="icon_desktop"></i>UPDATE CLASS</li>
      ...
      <div class="form">
        <form class="form-validate form-horizontal" id="register_form" method="post" action="" >
          ...
          <div class="form-group ">
            ...
            <div class="col-lg-10">
              <input class="form-control " id="classname" name="classname" type="text" value="{{$classroom->class_name}}"/>
              <input  id="class_id" name="class_id" type="hidden" value="{{$classroom->class_id}}" />
            </div>
          </div>
          <div class="form-group ">
            <label for="section" class="control-label col-lg-2">Section <span class="required">*</span></label>
            <div class="col-lg-10">
             <input class="form-control " id="section" name="section" type="text" value="{{$classroom->class_section}}"/>
           </div>
         </div>
         <div class="form-group">
           <label for="datepicker" class="control-label col-lg-2">Date:<span class="required">*</span></label>									
           <div class="col-lg-10">
            <input type="text" class="form-control " id="datepicker" name="datepicker" value="{{$classroom->class_date}}"/>
          </div>
        ...
        <div class="bootstrap-timepicker">
         <div class="form-group">
           ...
           <div class="col-lg-10">
             <input type="text" class="form-control timepicker" id="time" name="time" value="{{$classroom->class_time}}"/>
           </div>
         </div>
       </div>
     </br>
       <input type="hidden" id="course_id" value="{{$classroom->course_id}}">
       <div class="form-group ">
        <label for="parent" class="control-label col-lg-2">Course Name <span class="required">*</span></label>
        <div class="col-lg-6 ">
          <input class="form-control sameline" id="course" name="course" type="text" readonly value="{{$classroom->course->course_name}}"/>
...
<script>
 $("#register_form").validate({
  ...
  submitHandler: function(form) {
    ...
    $.post("{{ route('storeupdateclassroom') }}", {class_id:class_id,classname:classname,section:section,date:date,time:time,course_id:course_id,'_token':$('input[name=_token]').val()}, function(data) {
      $("#sucess").fadeIn();
      $('#sucess').html('<div class="alert alert-success fade in"><strong>Success!</strong> Classroom has been Saved.</div>');
     $("#sucess").fadeOut(5000);
      scrollTo(0,0);
