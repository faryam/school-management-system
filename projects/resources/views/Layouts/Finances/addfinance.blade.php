...
<div class="row">
  <div class="col-lg-12">
   <h3 class="page-header"><i class="fa fa-usd"></i> ADD FINANCE</h3>
   <ol class="breadcrumb">
    <li><i class="fa fa-home"></i><a href="{{ route('dashboard') }}">Home</a></li>
    <li><i class="fa fa-usd"></i>FINANCES</li>
    <li><i class="fa fa-usd"></i>ADD FINANCE</li>
  </ol>
</div>
</div>
      ...
      <div class="form">
        <form class="form-validate form-horizontal" id="register_form" method="post" action="" >
          <div class="form-group ">
            ...
            <div class="col-lg-10">
              <input class="form-control " id="finance_name" name="finance_name" type="text" />
            </div>
          </div>
        <div class="form-group ">
        ...
        <div class="form-group ">
            ...
            <div class="col-lg-10">
              <div class="radio sameline">
                <label>
                  <input type="radio" name="optionsRadios" id="optionsRadios1" value="option1" checked>RECEIVED   &emsp;     

                </label>
              </div>
              <div class="radio sameline">
                <label>
                  <input type="radio" name="optionsRadios" id="optionsRadios2" value="option2">PAID      
...
<script>
 $("#register_form").validate({
  ...
  submitHandler: function(form) {
    ...
    $.post("{{ route('storefinance') }}", {finance_name:finance_name,status:status,amount:amount,'_token':$('input[name=_token]').val()}, function(data) {

     $("#sucess").fadeIn();
     $('#sucess').html('<div class="alert alert-success fade in"><strong>Success!</strong> Finance has been Added</div>');
     $("#sucess").fadeOut(3000);
     scrollTo(0,0);
     console.log(data);
